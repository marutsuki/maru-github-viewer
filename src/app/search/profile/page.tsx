...
export default function Page() {
    ...
    return (
        <main
            className="grid h-full grid-cols-profile-layout grid-rows-profile-layout overflow-hidden md:overflow-y-auto sm:flex sm:flex-col p-4 sm:p-4 grid-areas-profile-layout [&>*]:m-2 sm:[&>*]:my-10 overflow-y-auto
            scrollbar-thin
