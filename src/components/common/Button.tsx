...
export default function Button({ text, onClick } : ButtonProps) {
    return <button className="group m-2 w-32 h-12 rounded-md relative bg-black/75 
    ...
    onClick={onClick}>
    <h2 className="text-md text-white duration-200 group-hover:text-theme-accent group-active:text-theme-active group-active:text-lg">{ text }</h2>
</button>
}